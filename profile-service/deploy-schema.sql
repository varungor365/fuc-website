...
-- Drop existing event_type if it exists to ensure clean deployment
DROP TYPE IF EXISTS public.event_type CASCADE;

-- Create the event_type enum with proper PostgreSQL syntax
DO $$ BEGIN
...
-- Now execute the main schema file
