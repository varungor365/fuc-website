...
export const metadata: Metadata = {export const metadata: Metadata = {
  ...
  title: 'Shopping Cart - FASHUN.CO',  title: 'Shopping Cart - FASHUN.CO',

  description: 'Review your cart and proceed to checkout',  description: 'Review your cart and proceed to checkout',
...
export default function CartPage() {export default function CartPage() {
  ...
  return (  return (
    ...
    <main className="min-h-screen bg-primary-900 py-24">
      ...
      <div className="max-w-4xl mx-auto px-6">    <main className="min-h-screen bg-primary-900 py-24">  {

        <div className="text-center mb-12">

          <h1 className="font-montserrat text-5xl font-bold text-white mb-6">      <div className="max-w-4xl mx-auto px-6">    id: 1,

            Shopping Cart

          </h1>        <h1 className="font-montserrat text-4xl font-bold text-white mb-8">    name: 'Oversized Black Hoodie',

          <p className="font-inter text-xl text-white/80">

            Review your items and proceed to checkout          Shopping Cart    price: 2999,

          </p>

        </div>        </h1>    originalPrice: 3999,



        {/* Empty Cart State */}    image: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=300&h=400&fit=crop&crop=center',

        <div className="bg-white/5 backdrop-blur-sm border border-white/20 rounded-xl p-12 text-center">

          <div className="w-24 h-24 bg-white/10 rounded-full mx-auto mb-8 flex items-center justify-center">        {/* Empty Cart State */}    color: 'Black',

            <svg className="w-12 h-12 text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">

              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />        <div className="bg-white/5 backdrop-blur-sm border border-white/20 rounded-xl p-12 text-center">    size: 'L',

            </svg>

          </div>          <div className="max-w-md mx-auto">    quantity: 2,
