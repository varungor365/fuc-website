...
import {
  ...
  HeartIcon as HeartAnimated,
  StarIcon as StarAnimated,
  GiftIcon,
  PartyIcon,
  TrophyIcon,
  PercentIcon,
...
import { BentoGrid, BentoCard, BentoProductCard } from '@/components/ui/bento-grid';
...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen mesh-gradient-1">
      {/* Promotional Banner with Animated Icons */}
      <section className="gradient-brand-primary shadow-gradient-glow text-white py-3 relative overflow-hidden">
      ...
      {/* Hero Section - STREETWEAR REVOLUTION with Enhanced Gradients */}
      <section className="relative min-h-screen overflow-hidden gradient-hero-cosmic pattern-gradient-dots">
        <div className="absolute inset-0 mesh-gradient-2 opacity-60"></div>
          ...
          <div className="text-center w-full">
            ...
            >
              <div className="space-y-6">
                ...
                >
                  <div className="glass-gradient-frosted shadow-gradient-glow px-8 py-4 rounded-full flex items-center gap-3">
                    <SparklesAnimated size={24} />
                    <span className="text-lg font-bold text-gradient-animate">
                      TRENDY & FRESH
                    </span>
                    <SparklesAnimated size={24} />
                  </div>
                ...
                <h1 className="text-6xl lg:text-8xl font-black leading-tight">
                  <motion.span 
                    ...
                    className="block text-gradient-primary gradient-text-shine mb-4"
                  >
                    STREETWEAR
                  </motion.span>
                  <motion.span 
                    ...
                    className="block text-gradient-fire gradient-text-shine"
                  >
                    REVOLUTION
                  </motion.span>
                </h1>
                ...
                <div className="max-w-4xl mx-auto space-y-4">
                  <p className="text-2xl lg:text-3xl font-bold text-gradient-gold">
                    India's Hottest T-Shirt Brand! 🚀
                  </p>
                  <p className="text-xl text-white/90 leading-relaxed glass-gradient-light p-6 rounded-2xl">
                  ...
                  <p className="text-lg font-semibold text-gradient-fire">
              ...
              >
                <motion.div
                  ...
                  className="will-change-gradient"
                >
                  <Link href="/collections/printed-tshirts">
                    <button className="btn-gradient-primary shadow-gradient-neon px-12 py-6 text-xl font-black rounded-2xl text-white relative z-10 overflow-hidden transition-all duration-400 hover-gradient-lift flex items-center gap-3">
                      <CartIcon size={28} />
                      SHOP NOW
                      <RocketIcon size={28} />
                    </button>
                ...
                >
                  <Link
                    ...
                    className="btn-gradient-outline shadow-gradient-glow px-12 py-6 text-xl font-black rounded-2xl inline-flex items-center justify-center gap-3 transition-all duration-400 hover-gradient-glow"
                  >
                    <AnimatedIcon icon="sparkles" animation="glow" size={28} gradient />
                    EXPLORE ALL
                    <AnimatedIcon icon="arrowRight" animation="bounce" size={28} />
                  </Link>
                </motion.div>
              </motion.div>
      ...
      {/* Features Bar with Animated Icons */}
      <section className="py-12 gradient-card-dark shadow-gradient-primary text-white border-t border-gradient-primary relative overflow-hidden">
        <div className="absolute inset-0 pattern-gradient-grid opacity-20"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { Icon: TruckAnimated, title: 'Free Shipping', desc: 'On orders over ₹2,999' },
              { Icon: ShieldIcon, title: '30-Day Returns', desc: 'Hassle-free returns' },
              { Icon: StarAnimated, title: 'Premium Quality', desc: '100% authentic' },
              { Icon: HeartAnimated, title: '50K+ Customers', desc: 'Trusted by thousands' },
            ].map((feature, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
                ...
                className="flex items-center gap-4 p-6 rounded-2xl glass-gradient-light hover:glass-gradient-frosted transition-all shadow-gradient-glow cursor-pointer"
              >
                <feature.Icon size={40} className="flex-shrink-0" />
                <div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <TextShimmer className="text-lg font-bold text-orange-600 mb-4">
              ✨ HANDPICKED FOR YOU ✨
            </TextShimmer>
      ...
      {/* New Arrivals with Gradient Enhancement */}
      <section className="py-20 relative overflow-hidden">
        <div className="absolute inset-0 gradient-animate-slow opacity-10"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-block glass-gradient-frosted shadow-gradient-glow px-8 py-3 rounded-full mb-4">
              <span className="text-gradient-animate font-bold">✨ Fresh Drops</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-black text-gradient-primary mb-4">New Arrivals</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">Be the first to get your hands on our latest streetwear pieces</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {featuredProducts.map((product, i) => (
              <motion.div
                ...
                className="group gradient-card-subtle rounded-2xl overflow-hidden border-gradient-primary shadow-gradient-primary hover:shadow-gradient-glow transition-all duration-400 hover-gradient-lift will-change-gradient"
              >
                <div className="relative aspect-[3/4] overflow-hidden">
                  ...
                  />
                  {product.badge && (
                    <span className={`absolute top-3 left-3 px-4 py-2 text-white text-xs font-black rounded-full shadow-gradient-glow ${
                      product.badge === 'New' ? 'gradient-brand-tertiary' :
                      product.badge === 'Trending' ? 'gradient-brand-primary' :
                      product.badge === 'Sale' ? 'gradient-pulse' :
                      product.badge === 'Limited' ? 'gradient-brand-secondary' :
          ...
          <div className="text-center mt-12">
            <Link href="/collections/new-arrivals">
              <button className="btn-gradient-primary shadow-gradient-neon px-12 py-6 text-xl font-black rounded-2xl text-white hover-gradient-lift transition-all duration-400">
      ...
      {/* Deal of the Day with Enhanced Gradients */}
      <section className="py-20 relative overflow-hidden">
        <div className="absolute inset-0 mesh-gradient-1"></div>
        <div className="absolute inset-0 pattern-gradient-grid opacity-30"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="glass-gradient-dark rounded-3xl shadow-gradient-neon overflow-hidden border-gradient-primary">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div className="relative aspect-square lg:aspect-auto">
                  ...
                  <div className="absolute top-6 left-6">
                    <div className="gradient-pulse shadow-gradient-neon text-white px-4 py-2 rounded-full font-black text-lg flex items-center gap-2">
                      <PercentIcon size={24} />
                      -50%
                    </div>
                  </div>
                  <div className="absolute top-6 right-6">
                    <div className="gradient-brand-primary shadow-gradient-glow text-white px-3 py-1 rounded-full font-semibold text-sm animate-pulse flex items-center gap-2">
                      <FlameIcon size={20} />
                      Only 23 left!
                    </div>
                  </div>
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  <div className="mb-6">
                    <div className="flex items-center gap-3 mb-4">
                      <FlameIcon size={32} />
                      <span className="text-2xl font-black text-gradient-fire gradient-text-shine">Deal of the Day</span>
                      <ZapIcon size={32} />
                    </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">Join thousands of happy customers wearing FASHUN.CO</p>
          </div>
