...
const hoodiesData = [
  ...
  },
  {
    ...
    price: 2799,
    originalPrice: 3299,
    image: 'https://images.unsplash.com/photo-1509631179647-0177331693ae?w=400&h=500&fit=crop&crop=center',
    category: 'hoodies',
    isNew: false,
    rating: 4.6,
    reviews: 156,
    colors: ['#808080', '#2D2D2D', '#FFFFFF'],
    sizes: ['S', 'M', 'L', 'XL']
  },
  {
    id: 9,
    ...
    price: 3799,
    originalPrice: 4799,
    image: 'https://images.unsplash.com/photo-1572804013427-4d7ca7268217?w=400&h=500&fit=crop&crop=center',
    category: 'hoodies',
    isNew: true,
    rating: 4.8,
    reviews: 234,
    colors: ['#000000', '#8B4513', '#2F4F4F', '#E4C590'],
    sizes: ['S', 'M', 'L', 'XL', 'XXL']
  },
  {
    id: 10,
    ...
    price: 2599,
    originalPrice: 3199,
    image: 'https://images.unsplash.com/photo-1578596112622-cd21f3c99f58?w=400&h=500&fit=crop&crop=center',
    category: 'hoodies',
    isNew: false,
    rating: 4.5,
    reviews: 167,
    colors: ['#8B4513', '#2D2D2D', '#696969'],
    sizes: ['S', 'M', 'L', 'XL']
  }
]
...
export default function HoodiesPage() {
  ...
  const [filteredProducts, setFilteredProducts] = useState(hoodiesData)

  // Get all unique colors and sizes
  const allColors = Array.from(new Set(hoodiesData.flatMap(p => p.colors || [])))
  const allSizes = Array.from(new Set(hoodiesData.flatMap(p => p.sizes || [])))

  useEffect(() => {
    let filtered = hoodiesData
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-[#E8E8E8] mb-6">
              Premium Streetwear Hoodies India
            </h1>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Discover India's most exclusive collection of premium streetwear hoodies. Crafted with the finest materials 
              for ultimate comfort and urban style. Perfect for every streetwear enthusiast and fashion-forward individual.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-2xl font-bold text-[#E8E8E8] mb-2">Hoodies Collection</h2>
                <p className="text-gray-400">
                  Showing {filteredProducts.length} of {hoodiesData.length} hoodies
                </p>
              </div>
            ...
            {filteredProducts.length === 0 && (
              <div className="text-center py-16">
                ...
                <h3 className="text-xl font-semibold text-[#E8E8E8] mb-2">No hoodies found</h3>
