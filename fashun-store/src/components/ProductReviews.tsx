...
const mockReviews: Review[] = [
  {
    ...
    userId: 'user1',
    userName: 'Arjun K.',
    userAvatar: '/images/products/hoodies/hoodie-1-main.jpg',
    verified: true,
    rating: 5,
    ...
    helpful: 24,
    notHelpful: 2,
    images: ['/images/products/hoodies/hoodie-1-front.jpg', '/images/products/hoodies/hoodie-1-back.jpg'],
    videos: [],
    size: 'L',
    fit: 'perfect',
    quality: 5,
  ...
  },
  {
    ...
    userId: 'user2',
    userName: 'Priya S.',
    userAvatar: '/images/products/t-shirts/tshirt-1-main.jpg',
    verified: true,
    rating: 4,
    ...
    helpful: 18,
    notHelpful: 5,
    images: ['/images/products/hoodies/hoodie-2-main.jpg'],
    videos: ['/images/products/hoodies/hoodie-2-main.jpg'],
    size: 'M',
    fit: 'perfect',
    quality: 4,
    valueForMoney: 4,
