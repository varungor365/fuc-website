  ...
  // FashUn.Co.in Brand Colors - Dark Premium Theme
      ...
      keyframes: {
        ...
        hologram: {
          ...
          '50%': { opacity: '0.7', transform: 'translateZ(10px)' },
        },
        neonPulse: {
          '0%, 100%': { 
        ...
        morpheus: {
          ...
          '25%': { borderRadius: '50px', transform: 'rotate(5deg)' },
          '50%': { borderRadius: '30px', transform: 'rotate(-5deg)' },
          '75%': { borderRadius: '40px', transform: 'rotate(3deg)' },
        },
        crystalShine: {
          '0%, 100%': { 
        ...
        liquidFlow: {
          '0%, 100%': { clipPath: 'polygon(0% 45%, 15% 44%, 32% 50%, 54% 60%, 70% 61%, 84% 59%, 100% 52%, 100% 100%, 0% 100%)' },
          '50%': { clipPath: 'polygon(0% 60%, 16% 65%, 34% 66%, 51% 62%, 67% 50%, 84% 45%, 100% 46%, 100% 100%, 0% 100%)' },
        },
        particleFloat: {
